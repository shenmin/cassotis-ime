...
- `cassotis_ime_host32.exe`（Win32 host 进程）
...
- Windows 10/11
- Delphi 10.4
- SQLite 运行库（`sqlite3_64.dll`、`sqlite3_32.dll`）
...
## 许可
开源发布前请在 `LICENSE` 中补充你的最终许可证文本。

若选择 GPL-3.0，请确保第三方声明与归属信息与 `THIRD_PARTY.md` 保持一致。
